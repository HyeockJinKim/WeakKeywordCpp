...
public class Parsing {
     ...
     */
    public static Optional<String> parseClass(String filePath, Set<CppClass> classSet) {
        try {
     ...
     */
    public static Optional<String> parseStaticCast(String filePath, Set<CppClass> classSet) {
        try {
